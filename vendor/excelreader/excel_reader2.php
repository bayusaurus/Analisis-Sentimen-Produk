	...
	function read($sFileName) {
		...
		if($res === false) {
			...
			if($this->_ole->error == 1) {
				// bad file
				die('File ' . $sFileName . ' anda tidak dapat diproses, Pastikan file anda berformat Microsoft Excel 97-2003 Worksheet (.xls) dan Sesuai dengan format yang disediakan. Kembali dan upload dengan format yang benar <button onclick="goBack()">Kembali</button>');
			}
