      ...
      <div class="col-md-10">
        ...
        <div class="row">
          <div class="col-md-12" style="background-color: #222224">
            <center><p class="mt-3 mb-3 text-white">Sentiment Analyzer</p></center>
          </div>
                    ...
                    if (isset($_GET['m'])) {
                      if ($_GET['m']=='ty') { ?>
                        <div class="alert alert-success alert-dismissible fade show mb-1 text-center " style="padding-top: 15px;">
                          <button type="button" class="close" data-dismiss="alert">&times;</button>
                          <strong>Terima kasih sudah memberikan pendapat anda.</strong>
                        </div>
                    <?php  }
                    }
                    ?>
                  ...
                  <div class="card-body bg-info">
                    <form action="hasil.php" method="post" enctype="multipart/form-data" id="myForm" class="mx-3 my-3">
                      <div class="form-group">
                        ...
                        <input class="form-control-file text-white" name="uji" type="file" placeholder="File" id="filexls" onchange="fileValidation2()" required="">
                      </div>
